...
<script type="text/javascript">
	function del() {
		document.getElementById("updateform").action = "/user/delete";
...
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="${root }/user/login" class="row g-3">
						<div class="col-12">
	...
	<div class="modal fade" id="exampleModalregist" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="${root }/user/register" class="row g-3">
						<div class="col-md-6">
						...
						<div class="col-12">
							...
							<input type="text" class="form-control" id="inputNumber"
								placeholder="010-xxxx-xxxx" name="phonenumber" />
						</div>
						<div class="col-12"
							style="width: fit-content; margin: auto; display: block; margin-top: 20px;">
							<button type="submit" class="btn btn-primary"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" id="modal-body-regist">
					<form action="${root }/user/update" class="row g-3" id="updateform">
						<div class="col-md-6">
	...
	<div class="modal fade" id="searchpw" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="${root }/user/searchpw" class="row g-3">
						<div class="col-12">
	...
	<div class="modal fade" id="ModalInfo" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">주변 지하철 정보</h5>
				</div>
				<div class="modal-body">
					<!-- Modal body -->
					<div id="sbinfo" class="modal-body"></div>
					<button type="button" class="btn btn-primary m-2"
						style="float: right;" data-bs-dismiss="modal">닫기</button>
				</div>
			</div>
		</div>
	</div>
	...
	<!-- The Modal -->
<!-- 	<div class="modal" id="ModalInfo" aria-labelledby="ModalInfo">
		<div class="modal-dialog">
			<div class="modal-content">
