...
public class AptServiceImpl implements AptService{
	...
	public ArrayList<AptDTO> select(String sido, String gugun, String dong, String key, String word) throws Exception {
		...
		map.put("key",(key == null || word == "" || key == "")? "1":key.trim());
	...
	@Override
	public ArrayList<AptDetailDTO> selectdetail(String aptcode) throws Exception {
		return aptMapper.selectdetail(aptcode);
	}
